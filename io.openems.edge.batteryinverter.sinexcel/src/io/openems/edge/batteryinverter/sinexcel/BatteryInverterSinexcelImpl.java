...
//						m(BatteryInverterSinexcel.ChannelId.SET_OFF_GRID_FREQUENCY, new SignedWordElement(138),	SCALE_FACTOR_MINUS_1)),
...
//						m(BatteryInverterSinexcel.ChannelId.BAUDRATE, new UnsignedWordElement(320))),
	...
	new UnsignedWordElement(326))),
				...
				new FC6WriteRegisterTask(752, //
						m(BatteryInverterSinexcel.ChannelId.SWITCHING_DEVICE_ACCESS_SETTING,	new UnsignedWordElement(752))),
	...
	new SignedWordElement(810), SCALE_FACTOR_MINUS_1)),
				...
				new FC6WriteRegisterTask(849, //
						m(BatteryInverterSinexcel.ChannelId.VOLTAGE_AND_REACTIVE_POWER_ADJUSTMENT_POINT_V1,	new SignedWordElement(849))),
				...
				new FC6WriteRegisterTask(887, //
						m(BatteryInverterSinexcel.ChannelId.CONTINUOS_OVER_VOLTAGE_TRIP_THRESHOLD,	new SignedWordElement(887))),
